...
import { workData } from "@/lib/data/siteData";
        ...
        >
          ...
          <div className="h-full flex flex-col md:flex-1 gap-3">
            <h1 className="font-medium text-slate-200">
              {item.jobtitle}{" "}
              <Link href={item.employerUrl} target="_blank" rel="noopener noreferrer" className="font-normal text-slate-200 hover:text-slate-400">
                @{item.employer}
              </Link>
            </h1>
